"""
Baseline A: Sentiment Word Counting (rule-based, multilingual)
--------------------------------------------------------------
Uses the NLTK Opinion Lexicon (Bing Liu). Rule: count positive and
negative words; majority wins, tie → neutral.

Note: The lexicon is English-based, so coverage is strongest for English
text, but the model is evaluated on the full multilingual dataset.

...
def main():
    ...
    # 7f. Final column selection and ID assignment
    ...
    print("\n" + "=" * 60)
    print("  STEP 8 – Train / Val / Test split  (92 / 4 / 4)")
    print("=" * 60)

    from sklearn.model_selection import train_test_split

    # Step 1: split off 8 % (val + test) with stratification
    ...
    # Step 2: split the 8 % equally into val and test (4 % each of total)
    ...
    print("\n  Multilingual splits (for mBERT + baselines):")
    ...
    print(f"  Output file        : sentiment_processed.csv  (multilingual)")
    print(f"  Split files        : sentiment_train/val/test.csv  (92/4/4, multilingual)")
    print("=" * 60)
